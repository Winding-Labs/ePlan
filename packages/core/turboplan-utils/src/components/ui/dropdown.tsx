...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ref={ref}
    className={cn(
      "flex cursor-default gap-2 select-none items-center px-2 py-1.5 text-sm outline-none data-[state=open]:bg-brandAlt-100 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
      GLASS_MENU_ITEM_CLASS,
      inset && "pl-8",
      className,
    )}
